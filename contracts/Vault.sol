...
// import {VaultDetails, Whitelisted, Loan, GMXPosition, Delta} from "./libraries/AppStorage.sol";
...
//                 IERC20(WHITELISTED_ASSETS[i]).balanceOf(address(this))
//             );
...
//                 WHITELISTED_DETAILS[curr_delta.collection].HEDGE_AT
//             ) {
